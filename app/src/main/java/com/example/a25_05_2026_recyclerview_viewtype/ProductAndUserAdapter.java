...
public class ProductAndUserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    TextView txtViewProductName,txtViewForProductPrice,txtViewForUsername,txtViewForCity;
    ...
    class ProductViewHolder extends RecyclerView.ViewHolder{
        public ProductViewHolder(@NonNull View itemView) {
            ...
            txtViewForProductPrice = itemView.
                    findViewById(R.id.txtViewForProductPrice);
        }
    }
